...
export default function ExperienceBox({data}: { data: ExperienceData }) {
    return (
        <div className={`${styles.box} ${data.name == "_filler" ? styles.filler : ""}
        ${data.boxHeight / data.boxWidth >= 1 ? styles.tall : styles.wide}`} style={{
            ...
            <div className={styles.textContainer}>
                {data.name == "_filler" ? <h3 className={styles.title}>Your Org Here?</h3> :
                    <>
                        <h3 className={styles.title}>{data.name} <span style={{color: "#ff0099"}}>/</span></h3>
